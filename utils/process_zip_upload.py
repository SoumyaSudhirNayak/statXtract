...
def process_zip_and_upload(zip_path, db_url, schema):
    uploaded_tables = []
    ...
    with zipfile.ZipFile(zip_path, 'r') as zip_ref:
        with tempfile.TemporaryDirectory() as extract_dir:
            ...
            for csv_file in csv_files:
                ...
                load_csv_to_postgres(full_path, safe_table_name, db_url, schema=schema)
            ...
            for sav_file in sav_files:
                ...
                if xml_match in xml_files:
                    ...
                    try:
                        ...
                        safe_table_name = get_safe_table_name(base_name, db_url)
                        load_csv_to_postgres(csv_out_path, safe_table_name, db_url, schema=schema)
                        uploaded_tables.append(safe_table_name)
